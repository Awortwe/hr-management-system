...
const navItems: NavItem[] = [
    ...
    { label: 'Project Sites', href: '/staff/project-sites', roles: ['admin', 'hr'] },
    { label: 'Attendance Map', href: '/staff/attendance-map', roles: ['admin', 'hr', 'manager'] },
    { label: 'Attendance Reports', href: '/staff/attendance-reports', roles: ['admin', 'hr', 'manager'] },
    { label: 'Corrections', href: '/staff/attendance-corrections', roles: ['admin', 'hr', 'manager'] },
